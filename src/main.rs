...
const FROZEN_SYMBOLS:   &'static str   = "0123456789aAsSzZxXcCvV";
...
9.0,  7.0,  4.5,  3.5,  3.5,  6.0,  8.0,  9.5,  6.5,  3.5,  3.5,  4.5,  7.0,
         2.5,  0.1, -0.2,  1.0,  2.0,  5.0,  2.5,  1.0, -0.2,  0.1,  2.5,  3.0,
           -0.5, -0.9, -1.2, -1.0,  1.0,  4.5,  1.0, -1.0, -1.2, -0.9, -0.5,  1.0,
